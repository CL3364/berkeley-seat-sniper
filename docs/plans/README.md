...
| [0009](0009-operator-alerting-and-parser-broke-runbook.md) | Operator alerting for parser-broke: monitored destination + debounce + runbook + class-gone vs shape-changed | [ADR 0009](../adr/0009-launch-posture-closed-pilot-then-public.md)                | Planned (pilot req) |
